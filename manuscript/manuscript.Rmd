...
fallmap<-gplot(Fall_SA) + 
  ...
  theme_classic()+
  theme(legend.position = c(0.95,.3),legend.text=element_text(size=rel(0.7)), legend.key.size=unit(.4,"line"), legend.background = element_rect(fill=alpha('white', 0)), text = element_text(size=8))+
  labs(title="Autumn drought freq.", x="Longitude (°)", y="Latitude (°)")
...
drought<-raster::raster("../data/VHP.G16.C07.npp.P2015050.VH.nc.grd")
...
nondrought<-raster::raster("../data/VHP.G16.C07.NJ.P1999050.VH.hdf.h5.grd")
...
typical<-raster::raster("../data/VHP.G16.C07.NP.P2012050.VH.hdf.h5.grd")
